...
public class ComController {
	...
	// TODO Confirm that Strings are received from Server (instead of printing strings to console, send strings over socket)
	...
	public String getCourseCatalogue() {
		...
		String courses = receiveMessageFromServer();
