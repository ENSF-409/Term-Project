...
1. Deployment of project; running the server and client on separate machines
2. Writing JUNIT tests for at least 2 classes
3. Maintaining a list of Student users (with pre-set names and id numbers) and developing a login/out feature for both Admin and Student
4. Create a separate GUI for an “Admin” with the functionality of creating new courses 
